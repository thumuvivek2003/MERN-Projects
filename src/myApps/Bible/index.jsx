    ...
    <div className="container mx-auto p-4">
      <Model>
        <div className="grid grid-cols-6 gap-3">
          ...
          <div className="w-100 m-3 col-span-2">
            <ThemeSelect themes={themes} selectedTheme={currentTheme} handleChange={handleThemeChange} heading="Theme" />
          </div>
          
        </div>
      <div className="grid grid-cols-4 gap-4">
        <h1 className="col-span-2 block text-lg font-semibold mb-2 ps-2 sevillana-regular">Book</h1>
        <h1 className="block text-lg font-semibold mb-2  ps-2 sevillana-regular">Chapter</h1>
        <h1 className="block text-lg font-semibold mb-2  ps-2 sevillana-regular">Verse</h1>
